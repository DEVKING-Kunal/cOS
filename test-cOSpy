...
#
# python script that tests cOS without having to boot it and type to its shell
#
# ./test-cOS.py usertests  (runs usertests)
# ./test-cOS.py -q usertests (runs the quick tests of usertests)
# ./test-cOS.py crash  (runs the crash tests)
# ./test-cOS.py log (runs the log crash test)
